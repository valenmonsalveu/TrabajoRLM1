...
# Transformación de 'Price' fuera del logaritmo para los gráficos
datosa$Price <- exp(datosa$`log(Price)`)

# 1. Precio vs Brand
plot(datosa$Brand, datosa$Price, 
     main = "Precio vs Brand",
     xlab = "Brand", ylab = "Price")

# 2. Precio vs Processor
plot(datosa$Processor, datosa$Price, 
     main = "Precio vs Processor",
     xlab = "Processor", ylab = "Price")

# 3. Precio vs Graphics
plot(datosa$Graphics, datosa$Price, 
     main = "Precio vs Graphics",
     xlab = "Graphics", ylab = "Price")

# 4. Precio vs RAM
plot(datosa$RAM, datosa$Price, 
     main = "Precio vs RAM",
     xlab = "RAM (GB)", ylab = "Price")

# 5. Precio vs Storage
plot(datosa$Storage, datosa$Price, 
     main = "Precio vs Storage",
     xlab = "Storage (GB)", ylab = "Price")

# 6. Precio vs Screen Size
plot(datosa$Screen.Size, datosa$Price, 
     main = "Precio vs Screen Size",
     xlab = "Screen Size (inches)", ylab = "Price")

# 7. Precio vs Operating System
plot(datosa$Operating.System, datosa$Price, 
     main = "Precio vs Operating System",
     xlab = "Operating System", ylab = "Price")

# 8. Precio vs Weight
plot(datosa$Weight, datosa$Price, 
     main = "Precio vs Weight",
     xlab = "Weight (kg)", ylab = "Price")

# 9. Precio vs Battery Life
plot(datosa$Battery.Life, datosa$Price, 
     main = "Precio vs Battery Life",
     xlab = "Battery Life (hours)", ylab = "Price")

# 10. Precio vs Warranty
plot(datosa$Warranty, datosa$Price, 
     main = "Precio vs Warranty",
     xlab = "Warranty (years)", ylab = "Price")
